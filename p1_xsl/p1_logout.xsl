...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template name="p1_logout" match="/root">
        <ul id="menu">
            ...
            <li style="margin:0 0 0 0;"><a id="selected" class="menu_link" href="../p1_php/p1_home.php?section=logout">Logout</a></li>
        </ul>
        
        <div id="content">
            
            
            So, you'd like to logout?
