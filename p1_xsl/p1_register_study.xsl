...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template name="p1_register_study" match="/root">
        <ul id="menu">
            ...
            <li><a id="selected" class="menu_link" href="../p1_php/p1_home.php?section=register_study">Register a New Study</a></li>
        ...
        <div id="content">
            ...
            So, you'd like to register a study?
