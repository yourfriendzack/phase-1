...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template name="p1_screen_new" match="/root">
        <ul id="menu">
            <li><a class="menu_link" href="../p1_php/p1_home.php">Home</a></li>
            <li><a id="selected" class="menu_link" href="../p1_php/p1_home.php?section=screen_new">Screen New Subject(s)</a></li>
        ...
        <div id="content">
            ...
            So, you'd like to screen a new subject?
